...
if(isset($_POST['tambah'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO barang (nama_barang, keterangan) VALUES (?, ?)");
    $stmt->bind_param("ss", $nama_barang, $keterangan);
...
if(isset($_POST['edit'])) {
    ...
    $stmt = $conn->prepare("UPDATE barang SET nama_barang=?, keterangan=? WHERE barang_id=?");
    $stmt->bind_param("ssi", $nama_barang, $keterangan, $barang_id);
...
$query = "SELECT * FROM barang ORDER BY barang_id ASC";
...
<!-- Header -->
<div class="header">
    <div class="title">Master Data Barang</div>
    <div class="user-info">
